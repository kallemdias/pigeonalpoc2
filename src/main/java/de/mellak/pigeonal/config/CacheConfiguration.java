package de.mellak.pigeonal.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, de.mellak.pigeonal.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, de.mellak.pigeonal.repository.UserRepository.USERS_BY_EMAIL_CACHE);
