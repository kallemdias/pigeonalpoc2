...
export default class DistanceCalculator extends mixins(JhiDataUtils) {
  ...
  public distanceCalculators: IDistanceCalculator[] = [];

  public isFetching = false;

  public mounted(): void {
    this.retrieveAllDistanceCalculators();
  }
  ...
  public retrieveAllDistanceCalculators(): void {
        ...
        res => {
          if (res.data && res.data.length > 0) {
            for (let i = 0; i < res.data.length; i++) {
              this.distanceCalculators.push(res.data[i]);
            }
  ...
  public prepareRemove(instance: IDistanceCalculator): void {
  ...
  public removeDistanceCalculator(): void {
    this.distanceCalculatorService()
      .delete(this.removeId)
      .then(() => {
        const message = 'A DistanceCalculator is deleted with identifier ' + this.removeId;
