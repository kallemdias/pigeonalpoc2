...
export default class GpsCoordinateCheck extends mixins(JhiDataUtils) {
  ...
  public gpsCoordinateChecks: IGpsCoordinateCheck[] = [];

  public isFetching = false;

  public mounted(): void {
    this.retrieveAllGpsCoordinateChecks();
  }
  ...
  public retrieveAllGpsCoordinateChecks(): void {
        ...
        res => {
          if (res.data && res.data.length > 0) {
            for (let i = 0; i < res.data.length; i++) {
              this.gpsCoordinateChecks.push(res.data[i]);
            }
  ...
  public prepareRemove(instance: IGpsCoordinateCheck): void {
  ...
  public removeGpsCoordinateCheck(): void {
    this.gpsCoordinateCheckService()
      .delete(this.removeId)
      .then(() => {
        const message = 'A GpsCoordinateCheck is deleted with identifier ' + this.removeId;
